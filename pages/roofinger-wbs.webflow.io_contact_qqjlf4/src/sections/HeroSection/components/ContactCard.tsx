    ...
    >
      ...
      <h2
        className={
          ...
          "text-xl font-bold box-border caret-transparent leading-6 mb-2.5 md:text-2xl md:leading-[28.8px]"
        }
      >
        {props.title}
      </h2>
      {props.isLink ? (
        ...
        <div
          className={props.contentClassName || "box-border caret-transparent"}
        >
          {props.content}
        </div>
      )}
