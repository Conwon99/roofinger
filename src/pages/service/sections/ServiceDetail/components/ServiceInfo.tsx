    ...
    <div className="items-start box-border caret-transparent gap-x-5 flex flex-col justify-start gap-y-5 md:gap-x-[50px] md:gap-y-[50px]">
      <div className="box-border caret-transparent">
        <h2 className="text-gray-900 text-[22px] font-bold box-border caret-transparent leading-[30.8px] mb-2.5 md:text-[34px] md:leading-[40.8px] md:mb-[30px]">
          About our roof installations
        </h2>
        <p className="box-border caret-transparent mb-2.5">
          Our roof installation services are designed to provide your home with
          a durable, weather-resistant roof that enhances the look of your
          property. Whether you need a new roof for your home or a commercial
          property, we offer various materials and styles to suit your needs.
        </p>
      </div>
      <div className="box-border caret-transparent">
        <h2 className="text-gray-900 text-[22px] font-bold box-border caret-transparent leading-[30.8px] mb-2.5 md:text-[34px] md:leading-[40.8px] md:mb-[30px]">
          Why choose our roof installations?
        </h2>
        <p className="box-border caret-transparent mb-2.5">
          Our installations combine top-quality materials and expert
          craftsmanship, ensuring durability and style for your homeâ€™s
          protection.
        </p>
        <ul
          role="list"
        ...
        >
          ...
          <li className="box-border caret-transparent mb-5">
            Licensed and experienced team for reliable craftsmanship.
          </li>
          <li className="box-border caret-transparent mb-5">
      ...
      <div className="box-border caret-transparent">
        ...
        >
          ...
          <li className="box-border caret-transparent mb-5">
            Roof Inspection: A thorough roof inspection to assess your
            requirements.
          </li>
          <li className="box-border caret-transparent mb-5">
