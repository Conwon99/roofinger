    ...
    <div className="items-center box-border caret-transparent flex basis-auto grow-0 shrink-0 justify-end justify-self-end md:basis-[0%] md:grow md:shrink md:mr-0 md:ml-auto">
      <div className="items-center box-border caret-transparent gap-x-1 hidden min-h-0 min-w-0 gap-y-1 md:flex md:min-h-[auto] md:min-w-[auto] md:gap-x-3">
        <a
          ...
          className="text-gray-900 items-center box-border caret-transparent gap-x-2.5 flex justify-start max-w-full gap-y-2.5 mr-2 whitespace-nowrap hover:text-yellow-500 hover:decoration-transparent hover:border-yellow-500"
        >
          <img
            src="https://c.animaapp.com/mhooxuovKXaEfR/assets/670f86de88858acaf330ddd9_phone.svg"
            alt=""
            className="box-border caret-transparent h-6 max-w-full w-6 md:h-7 md:w-7"
          />
          <div className="box-border caret-transparent text-sm font-medium md:text-lg">07710 981903</div>
        </a>
        <div className="box-border caret-transparent min-h-0 min-w-0 md:min-h-[auto] md:min-w-[auto]">
          <div className="box-border caret-transparent flex">
            <Link
              to="/contact"
              className="text-gray-900 items-center bg-yellow-500 box-border caret-transparent gap-x-3 flex max-w-full min-h-0 min-w-0 gap-y-3 text-center border px-4 py-2 rounded-[100px] border-solid border-transparent md:min-h-[auto] md:min-w-[auto] md:px-6 md:py-3 hover:bg-white hover:border-yellow-600"
            >
              <div className="relative box-border caret-transparent min-h-0 min-w-0 overflow-hidden md:min-h-[auto] md:min-w-[auto]">
                <div className="box-border caret-transparent">
                  <div className="relative text-sm font-medium box-border caret-transparent leading-5 z-[2] md:text-lg md:leading-7 md:font-semibold">
                    Get a free quote
                  </div>
                </div>
      ...
      <div
        aria-label="menu"
        role="button"
        className="relative text-gray-900 text-2xl box-border caret-transparent block float-right min-h-[auto] min-w-[auto] p-3 md:text-gray-900 md:hidden md:min-h-0 md:min-w-0 md:p-[18px]"
      >
