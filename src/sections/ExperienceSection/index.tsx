import { ExperienceImage } from "@/sections/ExperienceSection/components/ExperienceImage";
import { ExperienceContent } from "@/sections/ExperienceSection/components/ExperienceContent";

export const ExperienceSection = () => {
  return (
    <section className="box-border caret-transparent pt-[70px] pb-[50px] md:pt-[140px] md:pb-[70px]">
