import { VideoPlayer } from "@/sections/VideoSection/components/VideoPlayer";

export const VideoSection = () => {
  return (
    <section className="relative box-border caret-transparent mb-[-100px] z-[99] pt-[70px] md:mb-[-200px] md:pt-[140px]">
