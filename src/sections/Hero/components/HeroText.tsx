  ...
  return (
    <div className="box-border caret-transparent basis-[0%] grow max-w-[1100px]">
      <div className="box-border caret-transparent gap-x-4 flex flex-col gap-y-4">
        <div className="text-white text-base font-medium box-border caret-transparent blur-0 leading-[26px] md:text-lg">
          [Roofing & Scaffolding]
        </div>
        <h1 className="text-white text-[44px] font-semibold box-border caret-transparent blur-0 tracking-[-1.44px] leading-[52px] md:text-7xl md:leading-[80px]">
          Roofing & Scaffolding Specialists{" "}
          <span className="text-white text-[44px] italic box-border caret-transparent leading-[52px] font-playfair_display md:text-7xl md:leading-[80px]">
            Serving Ayrshire
          </span>
        </h1>
      ...
      <div className="items-center box-border caret-transparent gap-x-5 flex blur-0 flex-wrap gap-y-5 mt-6 md:gap-x-6 md:gap-y-6 md:mt-7">
        <div className="box-border caret-transparent flex">
          <Link
            to="/contact"
            className="text-gray-900 items-center bg-yellow-500 box-border caret-transparent gap-x-5 flex max-w-full gap-y-5 text-center border pl-6 pr-1 py-1 rounded-[100px] border-solid border-transparent hover:bg-white hover:border-yellow-600"
          >
        ...
        <div className="box-border caret-transparent flex">
          ...
          >
            <div className="text-white text-[15px] font-medium box-border caret-transparent leading-6 md:text-base">
              Explore our work
            </div>
