...
export const Hero = () => {
  return (
    <section className="relative bg-[url('/hero-bg.jpg')] bg-no-repeat bg-cover box-border caret-transparent h-screen w-full bg-[position:0px_0px] pt-[140px] md:pt-[120px]">
