  ...
  return (
    <div className="box-border caret-transparent basis-[0%] grow max-w-[650px]">
      <div className="box-border caret-transparent gap-x-4 flex flex-col gap-y-4">
        <div className="text-base font-medium box-border caret-transparent blur-0 leading-[26px] md:text-lg">
          [Lawn Mowing]
        </div>
        <h1 className="text-[44px] font-semibold box-border caret-transparent blur-0 tracking-[-1.44px] leading-[52px] md:text-7xl md:leading-[80px]">
        ...
        <div className="text-base box-border caret-transparent blur-0 leading-[26px] md:text-lg">
          Expert Lawn Mowing &amp; Gardening Services, Customized to Suit Your
          Property’s Unique Needs — Because Every Outdoor Space Deserves Expert
          Care
        </div>
      </div>
